...
using structure and display the record of the students in alphabetical order of
their names.
*/
...
int main() {
    ...
    // Sorting Logic (Bubble Sort - Alphabetical Order)
    for(i = 0; i < n - 1; i++) {
        for(j = 0; j < n - i - 1; j++) {
            // strcmp returns > 0 if the first string is "greater" (comes later)
